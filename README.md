...
#### Windows
Windows is not supported at this time! But I did compile Skyscraper 3.1.1 and it seemingly works ok. So just to be clear: You are on your own if you use this version. Get it [here](http://www.muldjord.com/downloads/Skyscraper_3.1.1_unsupported_win_version.zip).

...
#### Windows
Windows is not supported at this time! But I did compile Skyscraper 3.2.9 (development code) and it seemingly works ok. So just to be clear: You are on your own if you use this version - please don't ask me questions about it. Get it [here](http://www.muldjord.com/downloads/Skyscraper_3.2.9_unsupported_win_version.zip).

...
int main(int argc, char *argv[])
{
  ...
  QCommandLineOption flagsOption("flags", "Allows setting flags that will impact the run i various ways. See '--flags help' for all available flags", "FLAG1,FLAG2,...", "");
  ...
  QCommandLineOption nowheelsOption("nowheels", "Deprecated! See '--flags'. Disable wheels from being cached locally. Only do this if you do not plan to use the wheel artwork in 'artwork.xml'");
  QCommandLineOption nomarqueesOption("nomarquees", "Deprecated! See '--flags'. Disable marquees from being cached locally. Only do this if you do not plan to use the marquee artwork in 'artwork.xml'");
  QCommandLineOption skipexistingcoversOption("skipexistingcovers", "Deprecated! See '--flags'. When generating gamelists, skip processing covers that already exist in the media output folder.");
  QCommandLineOption skipexistingscreenshotsOption("skipexistingscreenshots", "Deprecated! See '--flags'. When generating gamelists, skip processing screenshots that already exist in the media output folder.");

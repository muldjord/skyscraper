...
int main(int argc, char *argv[])
{
  ...
  QCommandLineOption skippedOption("skipped", "When generating a gamelist, also include games that do not have any cached data.");
  ...
  QCommandLineOption skipexistingcoversOption("skipexistingcovers", "When generating gamelists, skip processing covers that already exist in the media output folder.");
  QCommandLineOption skipexistingscreenshotsOption("skipexistingscreenshots", "When generating gamelists, skip processing screenshots that already exist in the media output folder.");
  QCommandLineOption skipexistingwheelsOption("skipexistinwheels", "When generating gamelists, skip processing wheels that already exist in the media output folder.");
  QCommandLineOption skipexistingmarqueesOption("skipexistingmarquees", "When generating gamelists, skip processing marquees that already exist in the media output folder.");
  ...
  QCommandLineOption skipexistingvideosOption("skipexistingvideos", "When generating gamelists, skip copying videos that already exist in the media output folder.");

...
int main(int argc, char *argv[])
{
  ...
  QCommandLineOption pOption("p", "The platform you wish to scrape.\n(Currently supports 'amiga', 'apple2', 'arcade', 'atari2600', 'atari5200', 'atari7800', 'atarijaguar', 'atarist', 'c64', 'coleco', 'gamegear', 'gb, 'gba', 'gbc', 'genesis', 'mastersystem', 'megadrive', 'msx', 'n64', 'nds', 'neogeo', 'nes', 'pcengine', 'psp', 'psx', 'scummvm', 'segacd', 'snes', 'zxspectrum'. This option is mandatory)", "platform", "");

...
int main(int argc, char *argv[])
{
  ...
  QCommandLineOption purgedbOption("purgedb", "Purges all requested resources from the local database cache. You can define either module (m:[module]) or type (t:[type]) or both comma-separated. Set specific db folder with '-d' otherwise default db folder is used.", "resources", "");
